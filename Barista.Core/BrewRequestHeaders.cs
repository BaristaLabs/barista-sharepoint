namespace Barista
{
    ...
    [Serializable]
    public class BrewRequestHeaders : IEnumerable<KeyValuePair<string, IEnumerable<string>>>
    {
        [DataMember(Name = "Headers")]
        private readonly IDictionary<string, IEnumerable<string>> m_headers;

        /// <summary>
        /// Initializes a new instance of the <see cref="BrewRequestHeaders"/> class.
        /// </summary>
        /// <param name="headers">The headers.</param>
        public BrewRequestHeaders(IDictionary<string, IEnumerable<string>> headers)
        {
            this.m_headers = new Dictionary<string, IEnumerable<string>>(headers, StringComparer.OrdinalIgnoreCase);
        }
...
// ReSharper disable once PossibleMultipleEnumeration
        ...
        {
            get { return this.m_headers.Keys; }
        }
        ...
        {
            get { return this.m_headers.Values; }
        }
        ...
        {
            return this.m_headers.GetEnumerator();
        }
...
// ReSharper disable once PossibleMultipleEnumeration
        ...
        {
            if (!this.m_headers.ContainsKey(name))
            {
                return (T)(GetDefaultValue(typeof(T)) ?? default(T));
            }

            return converter.Invoke(this.m_headers[name]);
        }
        ...
        private void SetHeaderValues<T>(string header, T value, Func<T, IEnumerable<string>> valueTransformer)
        {
            ...
            {
                this.m_headers[header] = valueTransformer.Invoke(value);
            }
        }
    }
}
