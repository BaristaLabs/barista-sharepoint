namespace Barista.Extensions
{
  ...
  public static class EventHelperExtensions
  {
    ...
    [DebuggerHidden]
    public static void BeginRaise<T>(this EventHandler<T> handler, object sender, Barista.EventHelper.CreateEventArguments<T> createEventArguments, AsyncCallback callback, object asyncState)
      where T : EventArgs
    {
    ...
    [DebuggerHidden]
    public static void Raise<T>(this EventHandler<T> handler, object sender,Barista.EventHelper.CreateEventArguments<T> createEventArguments)
      where T : EventArgs
    {
