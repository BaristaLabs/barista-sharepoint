namespace Barista
{
    ...
    {
        private readonly byte[] m_boundaryAsBytes;
        private readonly byte[] m_closingBoundaryAsBytes;
        ...
        {
            this.m_boundaryAsBytes = boundaryAsBytes;
            this.m_closingBoundaryAsBytes = closingBoundaryAsBytes;
            this.m_buffer = new byte[this.m_boundaryAsBytes.Length];
        }
        ...
        {
            get { return this.m_buffer.SequenceEqual(this.m_boundaryAsBytes); }
        }
        public bool IsClosingBoundary
        {
            get { return this.m_buffer.SequenceEqual(this.m_closingBoundaryAsBytes); }
        }
        /// <summary>
        ...
        public bool IsFull
        {
            get { return this.m_position.Equals(this.m_buffer.Length); }
        }
