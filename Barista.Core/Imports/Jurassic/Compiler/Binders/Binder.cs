namespace Barista.Jurassic.Compiler
{
  ...
  {
    [NonSerialized]
    private BinderDelegate[] m_delegateCache;
    ...
    public BinderDelegate CreateDelegate(int argumentCount)
    {
      ...
      if (this.m_delegateCache == null)
        this.m_delegateCache = new BinderDelegate[MaximumCachedParameterCount + 1];
      var binderDelegate = this.m_delegateCache[argumentCount];
      if (binderDelegate == null)
      {
        ...
        this.m_delegateCache[argumentCount] = binderDelegate;
      }
