namespace Barista.Jurassic.Compiler
{
  ...
  {
    private readonly System.Reflection.Emit.ILGenerator m_generator;
    ...
    {
      this.m_generator.Emit(OpCodes.Pop);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Dup);
    }
    ...
    {
      return new ReflectionEmitILLabel(this.m_generator.DefineLabel());
    }
    ...
    public override void DefineLabelPosition(ILLabel label)
    {
      ...
      this.m_generator.MarkLabel(((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void Branch(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Br, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfZero(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Brfalse, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfNotZero(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Brtrue, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfEqual(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Beq, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfNotEqual(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Bne_Un, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfGreaterThan(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Bgt, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfGreaterThanUnsigned(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Bgt_Un, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfGreaterThanOrEqual(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Bge, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfGreaterThanOrEqualUnsigned(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Bge_Un, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfLessThan(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Blt, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfLessThanUnsigned(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Blt_Un, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfLessThanOrEqual(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Ble, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void BranchIfLessThanOrEqualUnsigned(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Ble_Un, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    public override void Switch(ILLabel[] labels)
    {
      ...
      this.m_generator.Emit(OpCodes.Switch, reflectionLabels);
    }
    ...
    {
      return new ReflectionEmitILLocalVariable(this.m_generator.DeclareLocal(type), name);
    }
    ...
    public override void LoadVariable(ILLocalVariable variable)
    {
      ...
      this.m_generator.Emit(OpCodes.Ldloc, ((ReflectionEmitILLocalVariable)variable).UnderlyingLocal);
    }
    ...
    public override void LoadAddressOfVariable(ILLocalVariable variable)
    {
      if (variable as ReflectionEmitILLocalVariable == null)
        throw new ArgumentNullException("variable");
      this.m_generator.Emit(OpCodes.Ldloca, ((ReflectionEmitILLocalVariable)variable).UnderlyingLocal);
    }
    ...
    public override void StoreVariable(ILLocalVariable variable)
    {
      if (variable as ReflectionEmitILLocalVariable == null)
        throw new ArgumentNullException("variable");
      this.m_generator.Emit(OpCodes.Stloc, ((ReflectionEmitILLocalVariable)variable).UnderlyingLocal);
    }
      ...
      switch (argumentIndex)
      {
        ...
        default:
          if (argumentIndex < 256)
            this.m_generator.Emit(OpCodes.Ldarg_S, (byte)argumentIndex);
          else
            this.m_generator.Emit(OpCodes.Ldarg, (short)argumentIndex);
          break;
      }
    }
    ...
    public override void StoreArgument(int argumentIndex)
    {
      if (argumentIndex < 0)
        throw new ArgumentOutOfRangeException("argumentIndex");
      if (argumentIndex < 256)
        this.m_generator.Emit(OpCodes.Starg_S, (byte)argumentIndex);
      else
        this.m_generator.Emit(OpCodes.Starg, (short)argumentIndex);
    }
    ...
    public override void LoadInt32(int value)
    {
      if (value >= -1 && value <= 8)
      {
        ...
        this.m_generator.Emit(OpCodes.Ldc_I4_S, (byte)value);
      else
    ...
    {
      this.m_generator.Emit(OpCodes.Cgt);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Cgt_Un);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Clt);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Clt_Un);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Add);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Sub);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Mul);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Div);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Rem);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.And);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Or);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Not);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Shl);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Shr);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Shr_Un);
    }
    ...
    public override void Box(Type type)
    {
      ...
      this.m_generator.Emit(OpCodes.Box, type);
    }
    ...
    public override void Unbox(Type type)
    {
      ...
      this.m_generator.Emit(OpCodes.Unbox, type);
    }
    ...
    public override void UnboxAny(Type type)
    {
      ...
      if (type.IsValueType == false)
        throw new ArgumentException(@"The type of the boxed value must be a value type.", "type");
      this.m_generator.Emit(OpCodes.Unbox_Any, type);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Conv_I4);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Conv_U4);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Conv_I8);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Conv_U8);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Conv_R8);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Conv_R_Un);
    }
    ...
    public override void CallStatic(System.Reflection.MethodBase method)
    {
      if (method is System.Reflection.ConstructorInfo)
        this.m_generator.Emit(OpCodes.Call, (System.Reflection.ConstructorInfo)method);
      else if (method is System.Reflection.MethodInfo)
        this.m_generator.Emit(OpCodes.Call, (System.Reflection.MethodInfo)method);
      else
    ...
    public override void CallVirtual(System.Reflection.MethodBase method)
    {
      ...
      if (method is System.Reflection.ConstructorInfo)
        this.m_generator.Emit(OpCodes.Callvirt, (System.Reflection.ConstructorInfo)method);
      else if (method is System.Reflection.MethodInfo)
        this.m_generator.Emit(OpCodes.Callvirt, (System.Reflection.MethodInfo)method);
      else
        throw new InvalidOperationException("Unsupported subtype of MethodBase.");
    }
    ...
    public override void LoadField(System.Reflection.FieldInfo field)
    {
      ...
      if (field.IsStatic)
        this.m_generator.Emit(OpCodes.Ldsfld, field);
      else
    ...
    public override void StoreField(System.Reflection.FieldInfo field)
    {
      if (field == null)
        throw new ArgumentNullException("field");
      this.m_generator.Emit(field.IsStatic ? OpCodes.Stsfld : OpCodes.Stfld, field);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Castclass, type);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Ldtoken, type);
    }
    ...
    {
      if (method is System.Reflection.ConstructorInfo)
        this.m_generator.Emit(OpCodes.Ldtoken, (System.Reflection.ConstructorInfo)method);
      else if (method is System.Reflection.MethodInfo)
        this.m_generator.Emit(OpCodes.Ldtoken, (System.Reflection.MethodInfo)method);
      else
        throw new InvalidOperationException("Unsupported subtype of MethodBase.");
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Ldtoken, field);
    }
    ...
    {
      if (method is System.Reflection.ConstructorInfo)
        this.m_generator.Emit(OpCodes.Ldftn, (System.Reflection.ConstructorInfo)method);
      else if (method is System.Reflection.MethodInfo)
        this.m_generator.Emit(OpCodes.Ldftn, (System.Reflection.MethodInfo)method);
      else
        throw new InvalidOperationException("Unsupported subtype of MethodBase.");
    }
    ...
    public override void LoadVirtualMethodPointer(System.Reflection.MethodBase method)
    {
      ...
      if (method is System.Reflection.ConstructorInfo)
        this.m_generator.Emit(OpCodes.Ldvirtftn, (System.Reflection.ConstructorInfo)method);
      else if (method is System.Reflection.MethodInfo)
        this.m_generator.Emit(OpCodes.Ldvirtftn, (System.Reflection.MethodInfo)method);
      else
        throw new InvalidOperationException("Unsupported subtype of MethodBase.");
    }
    ...
    public override void InitObject(Type type)
    {
      if (type == null)
        throw new ArgumentNullException("type");
      this.m_generator.Emit(OpCodes.Initobj, type);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Newarr, type);
    }
    ...
    public override void LoadArrayElement(Type type)
    {
      switch (Type.GetTypeCode(type))
      {
        case TypeCode.Byte:
        case TypeCode.SByte:
          this.m_generator.Emit(OpCodes.Ldelem_I1);
          break;
        case TypeCode.UInt16:
        case TypeCode.Int16:
          this.m_generator.Emit(OpCodes.Ldelem_I2);
          break;
        case TypeCode.UInt32:
        case TypeCode.Int32:
          this.m_generator.Emit(OpCodes.Ldelem_I4);
          break;
        case TypeCode.UInt64:
        case TypeCode.Int64:
          this.m_generator.Emit(OpCodes.Ldelem_I8);
          break;
        case TypeCode.Single:
          this.m_generator.Emit(OpCodes.Ldelem_R4);
          break;
        case TypeCode.Double:
          this.m_generator.Emit(OpCodes.Ldelem_R8);
          break;
        default:
          if (type.IsClass)
            this.m_generator.Emit(OpCodes.Ldelem_Ref);
          else
            this.m_generator.Emit(OpCodes.Ldelem, type);
          break;
      }
    }
    ...
    public override void StoreArrayElement(Type type)
    {
      switch (Type.GetTypeCode(type))
      {
        case TypeCode.Byte:
        case TypeCode.SByte:
          this.m_generator.Emit(OpCodes.Stelem_I1);
          break;
        case TypeCode.UInt16:
        case TypeCode.Int16:
          this.m_generator.Emit(OpCodes.Stelem_I2);
          break;
        case TypeCode.UInt32:
        case TypeCode.Int32:
          this.m_generator.Emit(OpCodes.Stelem_I4);
          break;
        case TypeCode.UInt64:
        case TypeCode.Int64:
          this.m_generator.Emit(OpCodes.Stelem_I8);
          break;
        case TypeCode.Single:
          this.m_generator.Emit(OpCodes.Stelem_R4);
          break;
        case TypeCode.Double:
          this.m_generator.Emit(OpCodes.Stelem_R8);
          break;
        default:
          if (type.IsClass)
            this.m_generator.Emit(OpCodes.Stelem_Ref);
          else
            this.m_generator.Emit(OpCodes.Stelem, type);
          break;
      }
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Ldlen);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Throw);
    }
    ...
    {
      this.m_generator.BeginExceptFilterBlock();
    }
    ...
    public override void Leave(ILLabel label)
    {
      if (label as ReflectionEmitILLabel == null)
        throw new ArgumentNullException("label");
      this.m_generator.Emit(OpCodes.Leave, ((ReflectionEmitILLabel)label).UnderlyingLabel);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Endfinally);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Endfilter);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Break);
    }
    ...
    {
      this.m_generator.Emit(OpCodes.Nop);
    }
  }
