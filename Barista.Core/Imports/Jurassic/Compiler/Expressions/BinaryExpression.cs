namespace Barista.Jurassic.Compiler
{
  ...
  internal class BinaryExpression : OperatorExpression
  {
    ...
    public override object Evaluate()
    {
      ...
      switch (this.OperatorType)
      {
        case OperatorType.Add:
          {
            ...
            if (TypeUtilities.IsString(leftPrimitive) || TypeUtilities.IsString(rightPrimitive))
        ...
        case OperatorType.Equal:
          return TypeComparer.Equals(left, right);
        case OperatorType.StrictlyEqual:
          return TypeComparer.StrictEquals(left, right);
    ...
    private void GenerateInstanceOf(ILGenerator generator, OptimizationInfo optimizationInfo)
    {
      ...
      generator.Call(ReflectionHelpers.FunctionInstance_HasInstance.Value);
