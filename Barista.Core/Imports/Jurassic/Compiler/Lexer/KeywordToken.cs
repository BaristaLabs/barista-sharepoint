namespace Barista.Jurassic.Compiler
{
  ...
  internal class KeywordToken : Token
  {
    ...
    private static Dictionary<string, Token> s_ecmaScript5LookupTable;
    private static Dictionary<string, Token> s_ecmaScript3LookupTable;
    private static Dictionary<string, Token> s_strictModeLookupTable;
