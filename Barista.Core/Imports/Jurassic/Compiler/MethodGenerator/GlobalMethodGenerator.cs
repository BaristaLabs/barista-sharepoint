...
// ReSharper restore UnusedAutoPropertyAccessor.Local
    ...
    protected override string GetMethodName()
    {
      ...
      return string.Format("global_{0}", sanitizedPath);
    }
    ...
    public object Execute()
    {
      ...
      var generatedMethod = this.GeneratedMethod;
      if (generatedMethod == null)
        throw new InvalidOperationException("Generated Method was null.");
      
      var result = ((Func<ScriptEngine, Scope, object, object>) generatedMethod.GeneratedDelegate)(this.Engine,
                                                                                                      this
                                                                                                        .InitialScope,
                                                                                                      this.Engine
                                                                                                          .Global);
