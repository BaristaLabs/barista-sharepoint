namespace Barista.Jurassic.Compiler
{
  ...
  public class DeclarativeScope : Scope
  {
    ...
    internal override DeclaredVariable DeclareVariable(string name, Expression valueAtTopOfScope, bool writable, bool deletable)
    {
      ...
      if (this.m_values != null && this.DeclaredVariableCount >= this.Values.Length)
        Array.Resize(ref this.m_values, this.DeclaredVariableCount + 10);
    ...
    public override void SetValue(string variableName, object value)
    {
      ...
      var variable = GetDeclaredVariable(variableName) ?? this.DeclareVariable(variableName, null, true, false);
