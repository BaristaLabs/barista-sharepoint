namespace Barista.Jurassic.Compiler
{
  ...
  {
    private Library.ObjectInstance m_scopeObject;

    [NonSerialized]
    private Expression m_scopeObjectExpression;

    private bool m_providesImplicitThisValue;
    ...
    {
      get { return this.m_scopeObject; }
      private set { this.m_scopeObject = value; }
    }
    ...
    {
      get { return this.m_scopeObjectExpression; }
      private set { this.m_scopeObjectExpression = value; }
    }
    ...
    {
      get { return this.m_providesImplicitThisValue; }
      private set { this.m_providesImplicitThisValue = value; }
    }
