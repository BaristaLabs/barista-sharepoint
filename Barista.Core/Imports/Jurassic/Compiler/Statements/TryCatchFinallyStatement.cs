  ...
  internal class TryCatchFinallyStatement : Statement
  {
    ...
    public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
    {
      ...
      if (this.CatchBlock != null)
      {
        ...
        generator.Call(ReflectionHelpers.JavaScriptException_ErrorObject.Value);
      ...
      if (this.FinallyBlock != null)
      {
        ...
        optimizationInfo.LongJumpCallback = (generator2, label) =>
            {
              ...
              generator2.NewObject(ReflectionHelpers.LongJumpException_Constructor.Value);
              generator2.Throw();
        ...
        if (branches.Count > 0)
        {
          ...
          generator.Call(ReflectionHelpers.LongJumpException_RouteId.Value);
