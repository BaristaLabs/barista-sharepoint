namespace Barista.Jurassic.Compiler
{
  ...
  {
    private readonly List<VariableDeclaration> m_declarations;
      ...
      : base(labels)
    {
      ...
      this.Scope = scope;
      this.m_declarations = new List<VariableDeclaration>(1);
    }
    ...
    {
      get { return this.m_declarations; }
    }
    ...
    public override IEnumerable<AstNode> ChildNodes
    {
      get
      {
        return this.Declarations
                   .Where(declaration => declaration.InitExpression != null)
                   .Select(
                     declaration =>
                     new AssignmentExpression(this.Scope, declaration.VariableName, declaration.InitExpression))
                   .Cast<AstNode>();
