namespace Barista.Jurassic
{
  ...
  public static class TypeUtilities
  {
    ...
    {
      if (IsUndefined(obj) || obj == Null.Value)
        yield break;
        ...
        foreach (var property in obj2.Properties)
        {
          ...
          if (names.Contains(property.Name) == false)
          {
            ...
            if (property.IsEnumerable)
            {
              ...
              if (obj2.HasProperty(property.Name))
              {
    ...
    public static object Add(object left, object right)
    {
      ...
      if (leftPrimitive is string || rightPrimitive is string || rightPrimitive is ConcatenatedString)
      {
