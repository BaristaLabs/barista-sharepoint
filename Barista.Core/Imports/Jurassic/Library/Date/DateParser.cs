  ...
  public static class DateParser
  {
    ...
    private static DateTime ParseUnstructured(string input)
    {
      ...
      for (int i = 0; i < words.Length; i++)
      {
        ...
        else if (s_monthNames.TryGetValue(word, out numericValue))
        {
          // If the word is a month name, guess the word is a month.
          month = numericValue;
        }
        else if (s_timeZoneNames.TryGetValue(word, out numericValue))
        {
        ...
        else if (int.TryParse(word, out numericValue))
        {
        ...
        else if (s_dayOfWeekNames.Contains(word))
        {
    ...
    private static HashSet<string> s_dayOfWeekNames;
    ...
    // month (1-12).
    private static Dictionary<string, int> s_monthNames;
    ...
    private static Dictionary<string, int> s_timeZoneNames;
