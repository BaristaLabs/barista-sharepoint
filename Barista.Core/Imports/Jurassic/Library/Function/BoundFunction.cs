namespace Barista.Jurassic.Library
{
  ...
  internal class BoundFunction : FunctionInstance
  {
      ...
      : base(targetFunction.Prototype)
    {
      ...
      this.FastSetProperty("name", targetFunction.Name, PropertyAttributes.Sealed, false);
      this.FastSetProperty("length", Math.Max(targetFunction.Length - boundArguments.Length, 0), PropertyAttributes.Sealed, false);
      this.FastSetProperty("prototype", this.Engine.Object.Construct(), PropertyAttributes.Writable, false);
      this.InstancePrototype.FastSetProperty("constructor", this, PropertyAttributes.NonEnumerable, false);
      ...
      this.FastSetProperty("caller", accessor, PropertyAttributes.IsAccessorProperty, true);
      this.FastSetProperty("arguments", accessor, PropertyAttributes.IsAccessorProperty, true);
    }
