namespace Jurassic.Library
{
  ...
  {
    [NonSerialized]
    private GeneratedMethod m_generatedMethod;

    [NonSerialized]
    private FunctionDelegate m_body;
    ...
    private void Init(string name, IList<string> argumentNames, Scope parentScope, string bodyText, GeneratedMethod generatedMethod, bool strictMode, bool hasInstancePrototype)
    {
      ...
      this.m_generatedMethod = generatedMethod;
      ...
      this.FastSetProperty("length", argumentNames.Count, PropertyAttributes.Sealed, false);

      // The empty function doesn't have an instance prototype.
      if (hasInstancePrototype)
      {
    ...
    public string DisassembledIL
    {
      get
      {
        ...
        return this.m_generatedMethod.DisassembledIL;
      }
    }
