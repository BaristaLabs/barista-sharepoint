namespace Jurassic.Library
{
  ...
  public class JSONObject : ObjectInstance
  {
    ...
    public static object Parse(ScriptEngine engine, string text, [DefaultParameterValue(null)] object reviver)
    {
      var parser = new JSONParser(engine, new JSONLexer(engine, new System.IO.StringReader(text)))
        {
          ReviverFunction = reviver as FunctionInstance
        };
      return parser.Parse();
    }
    ...
    public static string Stringify(ScriptEngine engine, object value, [DefaultParameterValue(null)] object replacer, [DefaultParameterValue(null)] object spacer)
    {
      var serializer = new JSONSerializer(engine)
      {
        ReplacerFunction = replacer as FunctionInstance
      };
