  ...
  public class NumberInstance : ObjectInstance
  {
    ...
    public string ToExponential(object fractionDigits)
    {
      ...
      if (TypeUtilities.IsUndefined(fractionDigits))
        return NumberFormatter.ToString(this.m_value, 10, NumberFormatter.Style.Exponential, -1);
      ...
      return NumberFormatter.ToString(this.m_value, 10, NumberFormatter.Style.Exponential, fractionDigits2);
    }

    /// <summary>
    /// Returns a string representing a number in fixed-point notation.
    /// </summary>
    /// <param name="fractionDigitsArg"> Number of digits after the decimal point. Must be in the
    ...
    {
      // NumberFormatter does the hard work.
      return NumberFormatter.ToString(this.m_value, 10, CultureInfo.CurrentCulture.NumberFormat, NumberFormatter.Style.Regular, 0);
    }
    ...
    public string ToPrecision(object precision)
    {
      ...
      // NumberFormatter does the hard work.
      return NumberFormatter.ToString(this.m_value, 10, NumberFormatter.Style.Precision, precision2);
    }

    /// <summary>
    /// Returns the textual representation of the number.
    /// </summary>
    /// <param name="radixArg"> Specifies a radix for converting numeric values to strings. </param>
