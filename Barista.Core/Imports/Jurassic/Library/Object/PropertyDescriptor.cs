namespace Jurassic.Library
{
  ...
  public struct PropertyDescriptor
  {
    ...
    public PropertyDescriptor(object value, PropertyAttributes attributes)
    {
      ...
      if (this.m_value is PropertyAccessorValue)
      {
        this.m_attributes |= PropertyAttributes.IsAccessorProperty;
        if (this.Setter != null)
          this.m_attributes |= PropertyAttributes.Writable;
        else
          this.m_attributes &= ~PropertyAttributes.Writable;
      }
    }
    ...
    {
      get { return this.m_value is PropertyAccessorValue; }
    }
    ...
    public FunctionInstance Getter
    {
      get
      {
        var accessor = this.m_value as PropertyAccessorValue;
        if (accessor == null)
          return null;
    ...
    public static PropertyDescriptor FromObject(ObjectInstance obj, PropertyDescriptor defaults)
    {
      ...
      if (obj.HasProperty("get"))
      {
        ...
        else if (TypeUtilities.IsUndefined(obj["get"]))
          getter = null;
        else
      ...
      if (obj.HasProperty("set"))
      {
        ...
        else if (TypeUtilities.IsUndefined(obj["set"]))
          setter = null;
        else
