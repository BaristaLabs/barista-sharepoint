namespace Barista.Jurassic.Library
{
  ...
  public class RegExpConstructor : ClrFunction
  {
    ...
    private System.Text.RegularExpressions.Match m_lastMatch;
    ...
    internal RegExpConstructor(ObjectInstance prototype)
      : base(prototype, "RegExp", new RegExpInstance(prototype.Engine.Object.InstancePrototype, string.Empty, null))
    {
    ...
    {
      this.DefineProperty(propertyName, new PropertyDescriptor(new PropertyAccessorValue(new ClrFunction(this.Engine.Function.InstancePrototype, getter, null, -1), null), attributes), false);
    }
    ...
    {
      if (this.m_lastMatch == null || this.m_lastMatch.Groups.Count < 1)
        return string.Empty;
      return this.m_lastMatch.Groups[1].Value;
    }
    ...
    {
      if (this.m_lastMatch == null || this.m_lastMatch.Groups.Count < 2)
        return string.Empty;
      return this.m_lastMatch.Groups[2].Value;
    }
    ...
    {
      if (this.m_lastMatch == null || this.m_lastMatch.Groups.Count < 3)
        return string.Empty;
      return this.m_lastMatch.Groups[3].Value;
    }
    ...
    {
      if (this.m_lastMatch == null || this.m_lastMatch.Groups.Count < 4)
        return string.Empty;
      return this.m_lastMatch.Groups[4].Value;
    }
    ...
    {
      if (this.m_lastMatch == null || this.m_lastMatch.Groups.Count < 5)
        return string.Empty;
      return this.m_lastMatch.Groups[5].Value;
    }
    ...
    {
      if (this.m_lastMatch == null || this.m_lastMatch.Groups.Count < 6)
        return string.Empty;
      return this.m_lastMatch.Groups[6].Value;
    }
    ...
    {
      if (this.m_lastMatch == null || this.m_lastMatch.Groups.Count < 7)
        return string.Empty;
      return this.m_lastMatch.Groups[7].Value;
    }
    ...
    {
      if (this.m_lastMatch == null || this.m_lastMatch.Groups.Count < 8)
        return string.Empty;
      return this.m_lastMatch.Groups[8].Value;
    }
    ...
    {
      if (this.m_lastMatch == null || this.m_lastMatch.Groups.Count < 9)
        return string.Empty;
      return this.m_lastMatch.Groups[9].Value;
    }
    ...
    public string GetLastParen()
    {
      if (this.m_lastMatch == null)
        return string.Empty;
      return this.m_lastMatch.Groups.Count > 1 ?
          this.m_lastMatch.Groups[this.m_lastMatch.Groups.Count - 1].Value :
          string.Empty;
    }
    ...
    public string GetLeftContext()
    {
      if (this.m_lastMatch == null)
        return string.Empty;
      return this.m_lastInput.Substring(0, this.m_lastMatch.Index);
    }
    ...
    public string GetRightContext()
    {
      if (this.m_lastMatch == null)
        return string.Empty;
      return this.m_lastInput.Substring(this.m_lastMatch.Index + this.m_lastMatch.Length);
    }
    ...
    /// <param name="flagsArg"> Available flags, which may be combined, are:
    ...
    public RegExpInstance Construct(object patternOrRegExp, [DefaultParameterValue(null)] object flagsArg)
    {
      var flags = JurassicHelper.GetTypedArgumentValue<string>(this.Engine, flagsArg, null);
