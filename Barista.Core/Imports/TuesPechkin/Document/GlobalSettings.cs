namespace Barista.TuesPechkin
{
    ...
    {
        private MarginSettings m_margins = new MarginSettings();
        ...
        internal string MarginBottom
        {
            get
            {
                return GetMarginValue(m_margins.Bottom);
            }
        }
        ...
        internal string MarginLeft
        {
            get
            {
                return GetMarginValue(m_margins.Left);
            }
        }
        ...
        internal string MarginRight
        {
            get
            {
                return GetMarginValue(m_margins.Right);
            }
        }
        ...
        internal string MarginTop
        {
            get
            {
                return GetMarginValue(m_margins.Top);
            }
        }
        ...
        internal string StringColorMode
        {
            get
            {
                ...
                {
                    return ColorMode == DocumentColorMode.Color ? "color" : "grayscale";
                }
                else
                {
                    return null;
