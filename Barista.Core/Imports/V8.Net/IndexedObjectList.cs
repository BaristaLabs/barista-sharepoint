namespace Barista.V8.Net
{
    ...
    public class IndexedObjectList<T> : IEnumerable<T> where T : class
    {
        ...
        /// </summary>
        /// <param name="capacity">The capacity allows to pre-allocate the internal list's initial length to reduce the need to keep reallocating memory as objects are added. (1000)</param>
