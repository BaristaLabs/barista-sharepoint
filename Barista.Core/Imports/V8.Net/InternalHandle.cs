...
namespace Barista.V8.Net
{
        ...
        IDynamicMetaObjectProvider
    {
        ...
        {
            return (bool)Types.ChangeType(handle.Value, typeof(bool), null);
        }

        public static implicit operator Int32(InternalHandle handle)
        {
            return (Int32)Types.ChangeType(handle.Value, typeof(Int32), null);
        }

        public static implicit operator double(InternalHandle handle)
        {
            return (double)Types.ChangeType(handle.Value, typeof(double), null);
        }
        ...
        {
            var ms = (double)Types.ChangeType(handle.Value, typeof(double), null);
        ...
        {
            return new JSProperty(handle, V8PropertyAttributes.None);
        }
        ...
        public override string ToString()
        {
            try
            {
                ...
                return val != null ? (string)Types.ChangeType(val, typeof(string), null) : "null";
            }
            catch (Exception ex)
            {
                return ex.GetFullErrorMessage(true);
            }
        }
