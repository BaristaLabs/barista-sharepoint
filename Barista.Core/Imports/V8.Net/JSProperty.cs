...
namespace Barista.V8.Net
{
    ...
    public class JSProperty<TValueSource> : IJSProperty, IHandleBased, IFinalizable
    {
        ...
        public JSProperty(V8PropertyAttributes attributes) { Source = default(TValueSource); _Attributes = attributes; }
        public JSProperty(TValueSource source, V8PropertyAttributes attributes) { Source = source; _Attributes = attributes; }
        public JSProperty(TValueSource source, InternalHandle value, V8PropertyAttributes attributes) : this(source, attributes) { _Value.Set(value); }
        public JSProperty(InternalHandle value, V8PropertyAttributes attributes) : this(default(TValueSource), value, attributes) { }
        public JSProperty(V8Engine engine, object value, V8PropertyAttributes attributes)
            : this(InternalHandle.Empty, attributes)
        {
            _Value.Set(engine != null ? engine.CreateValue(value, null, null) : InternalHandle.Empty);
        }
    ...
    public class JSProperty : JSProperty<object>
    {
        ...
        public JSProperty(object source, V8PropertyAttributes attributes) : base(source, attributes) { }
        public JSProperty(object source, InternalHandle value, V8PropertyAttributes attributes) : base(source, value, attributes) { }
        public JSProperty(InternalHandle value, V8PropertyAttributes attributes) : base(value, attributes) { }
        public JSProperty(V8Engine engine, object value, V8PropertyAttributes attributes) : base(engine, value, attributes) { }
