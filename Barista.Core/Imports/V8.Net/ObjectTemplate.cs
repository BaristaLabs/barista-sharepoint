namespace Barista.V8.Net
{
    ...
    public unsafe abstract class TemplateBase<ObjectType> : ITemplate, ITemplateInternal where ObjectType : class, IV8NativeObject
    {
        ...
        protected HandleProxy* _NamedPropertyGetter(string propertyName, ref ManagedAccessorInfo info)
        {
            ...
            {
                return _Engine.CreateError(Exceptions.GetFullErrorMessage(ex, true), JSValueType.ExecutionError);
            }
        }
    ...
    public unsafe class ObjectTemplate : TemplateBase<IV8ManagedObject>, IFinalizable
    {
        ...
        /// 
        /// </summary>
        /// <param name="v8EngineProxy"></param>
        /// <param name="registerPropertyInterceptors">(true)</param>
        internal void _Initialize(V8Engine v8EngineProxy, bool registerPropertyInterceptors)
        {
            _Initialize(v8EngineProxy,
                (NativeObjectTemplateProxy*)V8NetProxy.CreateObjectTemplateProxy(v8EngineProxy.NativeV8EngineProxy), // (create a corresponding native object)
        ...
        /// </summary>
        /// <param name="v8EngineProxy"></param>
        /// <param name="nativeObjectTemplateProxy"></param>
        /// <param name="registerPropertyInterceptors">true</param>
        ...
        public T CreateObject<T>(bool initialize) where T : V8NativeObject, new()
        {
            ...
            var obj = _Engine._CreateManagedObject<T>(this, InternalHandle.Empty, true);
        ...
        /// </summary>
        /// <param name="initialize">If true (default) then then 'IV8NativeObject.Initialize()' is called on the created object before returning. (true)</param>
        public V8ManagedObject CreateObject(bool initialize) { return CreateObject<V8ManagedObject>(initialize); }
            ...
            V8PropertyAttributes attributes, V8AccessControl access)
        {
            ...
            V8NetProxy.SetObjectTemplateAccessor(_NativeObjectTemplateProxy, -1, name,
                   _Engine._StoreAccessor<ManagedAccessorGetter>(_NativeObjectTemplateProxy->ObjectID, "get_" + name, (HandleProxy* _this, string propertyName) =>
                   {
                       ...
                       {
                           return engine.CreateError(Exceptions.GetFullErrorMessage(ex, true), JSValueType.ExecutionError);
                       }
                   }),
