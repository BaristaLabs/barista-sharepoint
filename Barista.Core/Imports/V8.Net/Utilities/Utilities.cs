...
namespace Barista.V8.Net
{
    ...
    public static class ExtensionMethods
    {
        ...
        /// <param name="defaultValue">(= default(TValue))</param>
        /// <returns></returns>
        ...
        /// <param name="timeout">Int32.MaxValue</param>
        /// <returns></returns>
        public static ReaderLock ReadLock(this ReaderWriterLock _this, Int32 timeout)
        {
        ...
        /// <param name="timeout">(Int32.MaxValue)</param>
        /// <returns></returns>
        public static WriterLock WriteLock(this ReaderWriterLock _this, Int32 timeout)
        {
