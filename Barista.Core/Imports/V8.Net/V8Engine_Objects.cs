...
namespace Barista.V8.Net
{
    ...
    public unsafe partial class V8Engine
    {
        ...
        /// Set this to false if native V8 objects will be associated manually for special cases.  This parameter is ignored if no handle is given (hNObj == null). (true)</param>
        ...
        /// <param name="createIfNotFound">If true, then an IV8NativeObject of type 'T' will be created if an existing IV8NativeObject object cannot be found, otherwise 'null' is returned. (true)</param>
        /// <param name="initializeOnCreate">If true (default) then then 'IV8NativeObject.Initialize()' is called on the created wrapper. (true)</param>
        ...
        /// <param name="createIfNotFound">(true)</param>
