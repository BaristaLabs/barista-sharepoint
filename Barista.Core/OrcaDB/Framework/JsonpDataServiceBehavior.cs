namespace Barista.OrcaDB.Framework
{
  ...
  public class JsonpDataServiceInspector : IDispatchMessageInspector
  {
    ...
    public void BeforeSendReply(ref System.ServiceModel.Channels.Message reply, object correlationState)
    {
      if (correlationState != null && correlationState is string)
      {
        ...
        string content = JsonpDataServiceInspector.encoding.GetString(reader.ReadContentAsBase64());
    ...
    class Writer : BodyWriter
    {
      ...
      protected override void OnWriteBodyContents(XmlDictionaryWriter writer)
      {
        ...
        byte[] buffer = JsonpDataServiceInspector.encoding.GetBytes(this.content);
  ...
  public sealed class JsonpDataServiceBehaviorAttribute : Attribute, IServiceBehavior
  {
    ...
    void IServiceBehavior.ApplyDispatchBehavior(ServiceDescription serviceDescription, ServiceHostBase serviceHostBase)
    {
      foreach (ChannelDispatcher cd in serviceHostBase.ChannelDispatchers)
      {
        ...
        {
          ed.DispatchRuntime.MessageInspectors.Add(new JsonpDataServiceInspector());
        }
      }
    }
