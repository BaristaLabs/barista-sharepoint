namespace Barista.Stateless
{
  ...
  public partial class StateMachine<TState, TTrigger>
  {
    ...
    {
      private readonly StateRepresentation m_representation;
      private readonly Func<TState, StateRepresentation> m_lookup;
      ...
      {
        return InternalPermit(trigger, m_representation.UnderlyingState);
      }
      ...
      {
        return InternalPermitIf(trigger, m_representation.UnderlyingState, guard);
      }
      /// <summary>
      ...
      {
        var superRepresentation = m_lookup(superstate);
        m_representation.Superstate = superRepresentation;
        superRepresentation.AddSubstate(m_representation);
        return this;
      }
      ...
      StateConfiguration InternalPermitDynamicIf(TTrigger trigger, Func<object[], TState> destinationStateSelector, Func<bool> guard)
      {
        Enforce.ArgumentNotNull(destinationStateSelector, "destinationStateSelector");
        Enforce.ArgumentNotNull(guard, "guard");
        m_representation.AddTriggerBehaviour(new DynamicTriggerBehaviour(trigger, destinationStateSelector, guard));
        return this;
      }
    }
  }
