namespace Barista.WebSocket
{
      ...
      where TWebSocketSession : WebSocketSession<TWebSocketSession>, new()
  {
    ...
    /// Gets the origin.
    /// </summary>
    public string Origin { get { return this.Items.GetValue(WebSocketConstant.Origin, string.Empty); } }
    ...
    string IWebSocketSession.GetAvailableSubProtocol(string protocol)
    {
      ...
      var arrNames = protocol.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
    ...
    private void SetCookie()
    {
      ...
      if (!string.IsNullOrEmpty(cookieValue))
      {
        ...
        foreach (var p in pairs)
        {
          ...
          var key = p.Substring(0, pos).Trim();
          pos += 1;
          string value = pos < p.Length
