namespace Barista.SharePoint.Library
{
    ...
    public class SPEventReceiverDefinitionInstance : ObjectInstance
    {
        ...
        public GuidInstance Host
        {
            get { return new GuidInstance(this.Engine.Object.InstancePrototype, m_eventReceiverDefinition.HostId); }
        }
        ...
        public string HostType
        {
            get
            {
                return m_eventReceiverDefinition.HostType.ToString();
            }
        }
