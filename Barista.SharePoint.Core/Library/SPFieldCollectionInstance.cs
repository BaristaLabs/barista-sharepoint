namespace Barista.SharePoint.Library
{
    ...
    public class SPFieldCollectionInstance : ObjectInstance
    {
        ...
        {
            return new SPFieldInstance(this.Engine, m_fieldCollection.CreateNewField(typeName, displayName));
        }
        ...
        public ArrayInstance ToArray()
        {
            var fields = m_fieldCollection
              .OfType<SPField>()
              .Select(f => new SPFieldInstance(this.Engine, f))
              .ToArray();
        ...
        public SPFieldInstance GetField(string name)
        {
            ...
            return new SPFieldInstance(this.Engine, field);
        }
