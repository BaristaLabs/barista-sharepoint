namespace Barista.SharePoint.Library
{
  ...
  public class SPIisWebServiceApplicationConstructor : ClrFunction
  {
    ...
    {
      return new SPIisWebServiceApplicationInstance(this.InstancePrototype);
    }
  }
  ...
  public class SPIisWebServiceApplicationInstance : ObjectInstance
  {
    ...
    {
      get { return new GuidInstance(this.Engine.Object.InstancePrototype, m_iisWebServiceApplication.Id); }
    ...
    public SPIisWebServiceApplicationPoolInstance ApplicationPool
    {
      get
      {
        if (m_iisWebServiceApplication.ApplicationPool == null)
          return null;
        return new SPIisWebServiceApplicationPoolInstance(this.Engine.Object.InstancePrototype,
