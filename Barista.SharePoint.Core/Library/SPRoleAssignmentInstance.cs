    ...
    public class SPRoleAssignmentConstructor : ClrFunction
    {
        ...
        public SPRoleAssignmentInstance Construct(object arg1, object arg2, object arg3, object arg4)
        {
            ...
            if (arg1 is SPPrincipalInstance)
                return new SPRoleAssignmentInstance(Engine.Object.InstancePrototype,
            ...
            return new SPRoleAssignmentInstance(Engine.Object.InstancePrototype, new SPRoleAssignment(loginName, email, name, notes));
        }
    }
    ...
    public class SPRoleAssignmentInstance : ObjectInstance
    {
        ...
        public object Member
        {
            get
            {
                ...
                if (m_roleAssignment.Member is SPUser)
                    return new SPUserInstance(Engine, m_roleAssignment.Member as SPUser);

                if (m_roleAssignment.Member is SPGroup)
                    return new SPGroupInstance(Engine, m_roleAssignment.Member as SPGroup);

                return new SPPrincipalInstance(Engine, m_roleAssignment.Member);
            }
        }
        ...
        public SPRoleDefinitionBindingCollectionInstance RoleDefinitionBindings
        {
            get
            {
                ...
                return new SPRoleDefinitionBindingCollectionInstance(Engine.Object.InstancePrototype, m_roleAssignment.RoleDefinitionBindings);
            }
        }
