namespace Barista.SharePoint.Migration.Library
{
  ...
  public class SPMigrationInstance : ObjectInstance
  {
    ...
    public ArrayInstance ExportFile(object file, object fileLocation, object baseFileName)
    {
      SPFile spFile = null;
      ...
      return ExportInternal(fileLocation, baseFileName, new List<SPExportObject> {exportObject});
    }

    [JSFunction(Name = "exportList")]
    public ArrayInstance ExportList(object list, object fileLocation, object baseFileName)
    {
      SPList spList;
    ...
    private ArrayInstance ExportInternal(object fileLocation, object baseFileName, IEnumerable<SPExportObject> exportObjects)
    {
