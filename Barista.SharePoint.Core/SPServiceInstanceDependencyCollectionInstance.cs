namespace Barista.SharePoint
{
  ...
  public class SPServiceInstanceDependencyCollectionConstructor : ClrFunction
  {
    ...
    {
      return new SPServiceInstanceDependencyCollectionInstance(this.InstancePrototype);
    }
  }
  ...
  public class SPServiceInstanceDependencyCollectionInstance : ObjectInstance
  {
    ...
    public SPServiceInstanceInstance GetServiceInstanceByGuid(object id)
    {
      ...
      return result == null
        ? null
        : new SPServiceInstanceInstance(this.Engine.Object.Prototype, result);
    }
    ...
    public ArrayInstance ToArray()
    {
      ...
      {
        ArrayInstance.Push(result, new SPServiceInstanceInstance(this.Engine.Object.InstancePrototype, serviceInstance));
      }
      return result;
    }
  }
