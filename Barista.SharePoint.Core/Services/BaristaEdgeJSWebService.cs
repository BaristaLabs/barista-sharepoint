namespace Barista.SharePoint.Services
{
    ...
    public class BaristaEdgeJSWebService : IBaristaWebService
    {
        ...
        private static void Brew(string code, string codePath)
        {
            ...
            request.ScriptEngineFactory = "Barista.SharePoint.SPBaristaEdgeJSScriptEngineFactory, Barista.SharePoint, Version=1.0.0.0, Culture=neutral, PublicKeyToken=a2d8064cb9226f52";
            request.Code = code;
