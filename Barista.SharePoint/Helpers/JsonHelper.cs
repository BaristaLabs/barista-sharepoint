namespace Barista.SharePoint
{
  ...
  public static class JsonHelper
  {
    ...
    {
      string originalJson = JsonConvert.SerializeObject(original, Formatting.Indented, settings);
      string sourceJson = JsonConvert.SerializeObject(source, Formatting.Indented, settings);
      string targetJson = JsonConvert.SerializeObject(target, Formatting.Indented, settings);
