...
namespace Barista.UnitTests.Jurassic
{
    ...
    public class StatementTests
    {
        ...
        public void Function()
        {
            ...
            Assert.IsInstanceOfType(TestUtils.Evaluate("var a; function a() { return 6 }; a"), typeof(Barista.Jurassic.Library.FunctionInstance));
            Assert.IsInstanceOfType(TestUtils.Evaluate("function a() { return 6 }; var a; a"), typeof(Barista.Jurassic.Library.FunctionInstance));
