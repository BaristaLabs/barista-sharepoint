    ...
    public class BigIntegerTests
    {
        ...
        public void LeftShift()
        {
            for (int i = 0; i < significantNumbers.Length; i++)
                for (int j = 0; j < 100; j += 19)
                {
                    ...
                    var actual = BigInteger.LeftShift(Barista.Jurassic.BigInteger.Parse(significantNumbers[i]), j);
        ...
        public new void ToString()
        {
          Barista.Jurassic.BigInteger.Parse("4294967295").ToString();
            for (int i = 0; i < significantNumbers.Length; i++)
            {
                ...
                var actual = Barista.Jurassic.BigInteger.Parse(significantNumbers[i]).ToString();
        ...
        public void Abs()
        {
            for (int i = 0; i < significantNumbers.Length; i++)
            {
                ...
                var actual = Barista.Jurassic.BigInteger.Abs(Barista.Jurassic.BigInteger.Parse(significantNumbers[i]));
        ...
        public void Log()
        {
            ...
            for (int i = 0; i < significantNumbers.Length; i++)
            {
                for (int j = 0; j < baseValues.Length; j++)
                {
                    ...
                    var actual = BigInteger.Log(Barista.Jurassic.BigInteger.Parse(significantNumbers[i]), baseValues[j]);
        ...
        public void ToDouble()
        {
            for (int i = 0; i < significantNumbers.Length; i++)
            {
                ...
                var actual = Barista.Jurassic.BigInteger.Parse(significantNumbers[i]).ToDouble();
