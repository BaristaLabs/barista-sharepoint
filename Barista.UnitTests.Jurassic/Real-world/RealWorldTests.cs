namespace Barista.UnitTests.Jurassic
{
  ...
  public class RealWorldTests
  {
    ...
    public void Showdown()
    {
      ...
      engine.ExecuteFile(@"..\..\..\Barista.UnitTests.Jurassic\Real-world\Files\showdown.js");
    ...
    public void ColorConversion()
    {
      ...
      var engine = new ScriptEngine();
      engine.ExecuteFile(@"..\..\..\Barista.UnitTests.Jurassic\Real-world\Files\color-conversion.js");
    ...
    public void sprintf()
    {
      ...
      var engine = new ScriptEngine();
      engine.ExecuteFile(@"..\..\..\Barista.UnitTests.Jurassic\Real-world\Files\sprintf.js");
    ...
    public void MD5()
    {
      ...
      var engine = new ScriptEngine();
      engine.ExecuteFile(@"..\..\..\Barista.UnitTests.Jurassic\Real-world\Files\md5.js");
    ...
    public void SHA1()
    {
      ...
      var engine = new ScriptEngine();
      engine.ExecuteFile(@"..\..\..\Barista.UnitTests.Jurassic\Real-world\Files\sha1.js");
    ...
    public void SHA256()
    {
      ...
      var engine = new ScriptEngine();
      engine.ExecuteFile(@"..\..\..\Barista.UnitTests.Jurassic\Real-world\Files\sha256.js");
    ...
    public void LZW()
    {
      ...
      var engine = new ScriptEngine();
      engine.ExecuteFile(@"..\..\..\Barista.UnitTests.Jurassic\Real-world\Files\lzw.js");
    ...
    public void Levenshtein()
    {
      ...
      var engine = new ScriptEngine();
      engine.ExecuteFile(@"..\..\..\Barista.UnitTests.Jurassic\Real-world\Files\levenshtein.js");
    ...
    public void CoffeeScript()
    {
      ...
      var engine = new ScriptEngine();
      engine.ExecuteFile(@"..\..\..\Barista.UnitTests.Jurassic\Real-world\Files\coffee-script.js");
      ...
      Assert.AreEqual(TestUtils.NormalizeText(@"
         ...
         TestUtils.NormalizeText(engine.Evaluate<string>("CoffeeScript.compile(script, {})")));
      System.IO.File.WriteAllText(@"actual.txt", TestUtils.NormalizeText(engine.Evaluate<string>("CoffeeScript.compile(script, {})")));
    }
